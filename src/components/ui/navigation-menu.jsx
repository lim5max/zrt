  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      <svg
        ...
        viewBox="0 0 10 10"
        fill="none"
        className="ml-1.5 shrink-0 -mt-1 transition duration-300 group-data-popup-open/navigation-menu-trigger:rotate-180 group-data-open/navigation-menu-trigger:rotate-180"
        aria-hidden="true">
    ...
    <NavigationMenuPrimitive.Portal>
      <NavigationMenuPrimitive.Positioner
        ...
        <NavigationMenuPrimitive.Popup
          className="data-[ending-style]:easing-[ease] xs:w-(--popup-width) relative h-(--popup-height) w-(--popup-width) origin-(--transform-origin) rounded-2xl bg-white text-dark-blue shadow-xl ring-1 ring-black/10 transition-[opacity,transform,width,height,scale,translate] duration-[0.35s] ease-[cubic-bezier(0.22,1,0.36,1)] outline-none data-ending-style:scale-90 data-ending-style:opacity-0 data-ending-style:duration-150 data-starting-style:scale-90 data-starting-style:opacity-0 overflow-hidden">
